...
class Ui_ModelTrainerUI(object):
    def setupUi(self, ModelTrainerUI):
        ...
        self.horizontalLayout_train_btn = QtWidgets.QHBoxLayout()
        self.train_settings_btn = QtWidgets.QPushButton(ModelTrainerUI)
        self.train_settings_btn.setObjectName("traing_settings_btn")
        self.horizontalLayout_train_btn.addWidget(self.train_settings_btn)
        ...
        self.epochs_spin.setObjectName('epochs_sping')
        ...
        self.verticalLayout.addWidget(self.train_settings_widget)
        spacerItem_train = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_train_btn.addItem(spacerItem_train)
        self.verticalLayout.addLayout(self.horizontalLayout_train_btn)
