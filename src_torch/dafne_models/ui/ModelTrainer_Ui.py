...
class Ui_ModelTrainerUI(object):
    def setupUi(self, ModelTrainerUI):
        ...
        self.train_mode_combo = QtWidgets.QComboBox(ModelTrainerUI)
        self.train_mode_combo.setObjectName("train_mode_combo")
        self.train_mode_combo.addItem("")
        self.train_mode_combo.addItem("")
        self.train_mode_combo.addItem("")
        self.horizontalLayout_3.addWidget(self.train_mode_combo)
    ...
    def retranslateUi(self, ModelTrainerUI):
        ...
        self.train_mode_combo.setItemText(0, _translate("ModelTrainerUI", "Train from scratch"))
        self.train_mode_combo.setItemText(1, _translate("ModelTrainerUI", "Fine-tune"))
        self.train_mode_combo.setItemText(2, _translate("ModelTrainerUI", "LoRA (Low Rank Adaptation)"))
